package com.onesidedcabs.residemenu;
...
import com.onesidedcabs.FeedbackFormActivity;
import com.onesidedcabs.MenuActivity;
import com.onesidedcabs.My_rides;
import com.onesidedcabs.R;
import com.onesidedcabs.User_Profile;
...
public class ResideMenu extends FrameLayout {
    ...
    private void initViews(final Context context, int customLeftMenuId,
        ...
        if (customLeftMenuId >= 0) {
            ...
            TextView book = (TextView) scrollViewLeftMenu.findViewById(R.id.book);
            ...
            TextView username = (TextView) scrollViewLeftMenu.findViewById(R.id.username);
            username.setText(PrefUtils.getUser(context).getUser().get(0).getName());


            TextView t_click = (TextView) scrollViewLeftMenu.findViewById(R.id.click);

            t_click.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {

                    // Toast.makeText(context, " HI 1S", Toast.LENGTH_SHORT).show();
            ...
            TextView profile = (TextView) scrollViewLeftMenu.findViewById(R.id.profile);
            ...
            TextView help = (TextView) scrollViewLeftMenu.findViewById(R.id.help);
            ...
            help.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.setData(Uri.parse("tel:" + "8000807807"));
            ...
            TextView feedback = (TextView) scrollViewLeftMenu.findViewById(R.id.feedback);
